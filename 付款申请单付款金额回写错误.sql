select pk_apply,
       ...
       paysum, --付款金额合计                    23500674.39
       glcunpaysum, --未付金额合计(集团本币)     15207543.21 
 ...
 where vbillno = 'SS19022696'
   and pk_apply = '1001D110000000FVFPGH'
   for update --1001D110000000FVFPGH
;
...
select paymny, --累计付款金额
       ...
       busistatus
  from cmp_apply_b
 where pk_apply = '1001D110000000FVFPGH'
   for update
